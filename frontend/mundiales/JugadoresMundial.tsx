...
// recharts is a heavy dependency; split it into its own chunk so it's only
// fetched once the stats panel actually renders, instead of on every page load.
const TopScorersChart = dynamic(() => import("@/mundiales/TopScorersChart"), {
  ssr: false,
  loading: () => <div className="h-[180px] animate-pulse rounded-lg bg-gray-100" />,
});
              ...
              <CardContent>
                {topScorers.length > 0 ? (
                  <div className="space-y-3">
                    ...
                    <TopScorersChart topScorers={topScorers} year={year} />
                  </div>
                ) : (
