          ...
          <div className="text-center space-y-6">
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-center gap-3">
                ...
                <span className="text-[var(--wc-gold)] text-5xl sm:text-7xl lg:text-8xl font-black tracking-tighter">{String(year).slice(2)}</span>
      ...
      <section className="container mx-auto px-4 py-10 space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="border-[var(--wc-gold)]/10 shadow-sm hover:shadow-lg hover:shadow-[var(--wc-gold)]/5 transition-shadow duration-300 bg-white">
            <CardHeader className="pb-3">
              <CardTitle className="text-base flex items-center gap-2">
                <div className="h-8 w-8 rounded-lg bg-[var(--wc-gold)]/10 flex items-center justify-center"><TrendingUp className="h-4 w-4 text-[var(--wc-gold-dark)]" /></div>
                Últimos Resultados
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-2">
              ...
              {latest.map((p) => (
                <Link key={p._id} href={`/mundiales/${year}/partidos`}>
                  <div className="flex items-center justify-between rounded-xl border border-[var(--wc-gold)]/10 p-3.5 hover:bg-[var(--wc-gold)]/[0.03] hover:shadow-md transition-all duration-200 cursor-pointer group">
                    ...
                    <div className="flex flex-col items-center mx-3 shrink-0">
                      <span className="text-sm font-bold bg-[var(--wc-gold)] text-white px-2.5 py-0.5 rounded-md">{p.marcador.ft[0]} - {p.marcador.ft[1]}</span>
                    </div>
          ...
          <Card className="border-[var(--wc-gold)]/10 shadow-sm hover:shadow-lg hover:shadow-[var(--wc-gold)]/5 transition-shadow duration-300 bg-white">
            <CardHeader className="pb-3">
              <CardTitle className="text-base flex items-center gap-2">
                <div className="h-8 w-8 rounded-lg bg-[var(--wc-gold)]/10 flex items-center justify-center"><Calendar className="h-4 w-4 text-[var(--wc-gold-dark)]" /></div>
                Próximos Partidos
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-2">
          ...
          <Card className="border-[var(--wc-gold)]/10 shadow-sm bg-white">
            <CardHeader className="pb-3">
              <CardTitle className="text-base flex items-center gap-2">
                <div className="h-8 w-8 rounded-lg bg-[var(--wc-gold)] flex items-center justify-center"><Target className="h-4 w-4 text-white" /></div>
                Goleadores Top
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-2">
          ...
          <Card className="border-[var(--wc-gold)]/10 shadow-sm bg-white">
            ...
            <CardContent className="space-y-4">
              ...
              {grupos && (
                <Link href={`/mundiales/${year}/grupos`} className="block text-center text-sm text-[var(--wc-gold-dark)] hover:text-[var(--wc-gold)] font-medium transition-colors mt-2">
