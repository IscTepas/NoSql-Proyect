...
export default function Mundial2022Page() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[var(--wc-gold)]/5 to-white">
      <div className="container mx-auto px-4 py-8 space-y-6">
        ...
        <div className="text-center py-20 space-y-6">
          ...
          <div>
            <h1 className="text-4xl font-black text-[var(--wc-black)] mb-2">2022</h1>
            <p className="text-muted-foreground text-sm">FIFA World Cup Qatar</p>
          </div>
          ...
          <p className="text-muted-foreground text-sm max-w-md mx-auto">
            Los datos del mundial Qatar 2022 estarán disponibles en una futura actualización.
          </p>
        </div>
      </div>
    </div>
