...
- **AHORA**: Solo renderiza `WorldCupCarousel` con título y subtítulo
- El dashboard anterior se preservará cuando se creen las rutas `/mundiales/2026`
...
- Logo cambiado de "WC 2026" a "FIFA World Cups"
...
### 1. Crear rutas para cada mundial
```
frontend/app/mundiales/2026/page.tsx  → Dashboard del 2026 (mover home actual)
frontend/app/mundiales/2022/page.tsx  → Dashboard del 2022
frontend/app/mundiales/2018/page.tsx  → Dashboard del 2018
frontend/app/mundiales/2014/page.tsx  → Dashboard del 2014
```
